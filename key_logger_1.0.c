//@:KEY_LOGGER-v1.0::for windows platform;
//@:for running it in background compile it as GUI not as console
//:https://www.facebook.com/profile.php?id=100006129615061
